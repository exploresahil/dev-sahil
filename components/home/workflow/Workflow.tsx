      ...
      <div className="left">
        <div className="img_container" ref={imgContainerRef}>
          <motion.img
            ...
            src="https://images.unsplash.com/photo-1639395241103-9c855f93a90c?q=80&w=1896&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="workflow"
          />
          <Noise />
        </div>
