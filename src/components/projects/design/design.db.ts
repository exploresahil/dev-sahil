...
export const brandData: BrandDataType[] = [
  ...
  },
  {
    ...
    desc: "Where art, travel, and aesthetics converge. Join in to draw the world with a spectrum of creative expressions - mural, acrylic, gauche, clay. Unleash your inner artist, spilling colors on the canvas of life.",
    link: "/design",
  },
  {
    title: "dessertbar",
