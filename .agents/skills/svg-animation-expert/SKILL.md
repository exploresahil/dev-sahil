...
description: Use when animating SVG icons or illustrations, creating path drawing/tracing animations, morphing shapes, building animated logos, or working with SVG line art animations
---
